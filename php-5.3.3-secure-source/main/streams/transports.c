		...
		STREAMS_DC TSRMLS_DC)
{
	...
	/*** Disable streams the ugly way -- AlecTBM***/
	error_text = "You have used an function that is not allowed in phpgolf!";
	phpgolf();
//        ERR_RETURN(error_string, error_text, "You have used an function that is not allowed in phpgolf!");
//	return NULL;
        /*** - ***/
	if (timeout == NULL) {
